# Install script for directory: /workspace/vllm
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "cumem_allocator" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/vllm" TYPE MODULE FILES "/workspace/vllm/build_docker/cumem_allocator.abi3.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/cumem_allocator.abi3.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/cumem_allocator.abi3.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/cumem_allocator.abi3.so"
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/workspace/vllm/build_docker/_deps/cutlass-build/cmake_install.cmake")
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "_C" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/vllm" TYPE MODULE FILES "/workspace/vllm/build_docker/_C.abi3.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/_C.abi3.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/_C.abi3.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/_C.abi3.so"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "_moe_C" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/vllm" TYPE MODULE FILES "/workspace/vllm/build_docker/_moe_C.abi3.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/_moe_C.abi3.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/_moe_C.abi3.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/vllm/_moe_C.abi3.so"
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for the subdirectory.
  include("/workspace/vllm/build_docker/vllm-flash-attn/cmake_install.cmake")
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "_vllm_fa2_C" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/vllm/vllm_flash_attn" TYPE DIRECTORY FILES "/workspace/vllm/build_docker/_deps/vllm-flash-attn-src/vllm_flash_attn/" FILES_MATCHING REGEX "/[^/]*\\.py$")
endif()
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/workspace/vllm/build_docker/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/workspace/vllm/build_docker/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
